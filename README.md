# 데이터 전처리 에이전트 (LangGraph + FastAPI)

시연 영상(유튜브 링크)
1. https://youtu.be/ViEkAgjw-KA (지인 실제 업무 처리)
2. https://youtu.be/UL4xvBqoX5w (타이타닉 데이터 전처리)
3. https://youtu.be/FD1A888kNOo (호텔 부킹 데이터 전처리)
